...
function Picture() {
    const slides = [
        {
            url: "./images/foto_bareng.jpg"
        },
        {
            url: "./images/foto_bareng2.jpeg"
        },
        {
            url: "./images/stas_lengkap.png"
        },
    ]
    ...
    return(
        <div className="max-w-[1400px] h-[550px] w-full m-auto py-5 px-4 relative group">
