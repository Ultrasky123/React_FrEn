...
const Content = () => {
    return(
        ...
        <ul className="text-center text-xl p-10">
                        ...
                        <Link to='/instructor'><li className="my-4 py-4 border-b border-green-200 text-green-200 hover:text-green-950 transition-all duration-150 hover:bg-green-200 hover-rounded">Teams</li></Link>
